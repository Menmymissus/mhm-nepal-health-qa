...
const About = () => {
  ...
  return (
     ...
     {/* <div className='h-[100vh] flex-grow overflow-y-auto 'style={{ maxHeight: "650px" }}> */}
    <div className="absolute top-0 left-0 h-full w-full bg-cover text-slate-300 font-spaceGrotesk space-x-4 flex flex-col items-center justify-center md:px-32 px-5 overflow-y-auto" style={{backgroundImage:`url(${background})`}}>
      <h1 className="text-3xl sm:text-4xl font-bold text-center mb-8">Meet Our Team</h1>
